...
- **S&P 500 (SPY):** 739.17, up 0.21% (latest live close from May 15, 2026).
- **NASDAQ-100 (QQQ):** 708.93, down 0.32% (latest live close from May 15, 2026).
- **DOW (DIA):** 495.37, down 0.15% (latest live close from May 15, 2026).
- **Europe (VGK):** 85.79, down 2.64% (latest live close from May 15, 2026).
- **Japan (EWJ):** 91.07, down 1.25% (latest live close from May 15, 2026).
- **China (MCHI):** 56.64, down 2.88% (latest live close from May 15, 2026).
- **India (INDA):** 47.99, down 3.71% (latest live close from May 15, 2026).
- **China large-cap (FXI):** 36.20, down 2.79% (latest live close from May 15, 2026).
- **Bitcoin:** 78039.58, down 1.56% (latest live print from May 17, 2026).
- **Ethereum:** 2182.27, down 3.34% (latest live print from May 17, 2026).
- **Gold (GLD):** 417.29, down 3.80% (latest live close from May 15, 2026).
- **Oil proxy (USO):** 148.23, up 10.96% (latest live close from May 15, 2026).
- **CrowdStrike (CRWD):** 594.08, up 12.56% (latest live close from May 15, 2026).
- **Exxon Mobil (XOM):** 157.92, up 9.23% (latest live close from May 15, 2026).
- **Boeing (BA):** 220.49, down 7.11% (latest live close from May 15, 2026).
- **AMD (AMD):** 424.10, down 6.83% (latest live close from May 15, 2026).
- **US CPI (YoY):** 3.8% as of Apr. 2026. Source: [BLS via FRED](https://fred.stlouisfed.org/series/CPIAUCSL)
...
- **US 10-year Treasury:** 4.47% latest daily close on May 14, 2026. Source: [Treasury via FRED](https://fred.stlouisfed.org/series/DGS10)
...
**Link:** [Read at arXiv](https://arxiv.org/abs/2605.13490)
...
**Link:** [Read at arXiv](https://arxiv.org/abs/2605.13350)

### Short Takes

- **Machine learning for science is maturing where it becomes explicit about prior knowledge instead of pretending all discovery is end-to-end pattern extraction:** the new *Communications Physics* perspective is strongest when it distinguishes data-rich, theory-rich, and theory-poor regimes rather than treating ML as one universal method. [Source](https://www.nature.com/articles/s42005-026-02676-7)
- **Bee-inspired navigation is a better robotics story than another oversized autonomy demo:** Nature’s Bee-Nav work shows a tiny drone can learn a home vector from a compact local flight and run it on energy-efficient hardware, which is exactly the sort of constraint-aware progress field systems need. [Source](https://www.nature.com/articles/s41586-026-10461-3)
- **The reported signs of an eta-prime mesic nucleus are worth watching because they could turn a longstanding QCD mass question into something spectroscopically testable in nuclear matter.** [Source](https://physicsworld.com/a/physicists-spot-signs-of-an-atom-like-system-bound-by-the-strong-force-alone/)
...
**Link:** [Read at AP News](https://apnews.com/article/353c768987542843e2033aa684266879)
...
**Link:** [Read at AP News](https://apnews.com/article/3164d723ca8331e5780ec7942245a2e6)
...
**Link:** [Read at the European Commission](https://finance.ec.europa.eu/news/eu-adopts-20th-package-sanctions-against-russia-2026-04-23_en) and [Read at NATO](https://www.nato.int/cps/en/natohq/topics_49198.htm)

### Breaking News

- **The Moscow strike pattern is no longer exceptional enough to dismiss as symbolism:** AP reports that one of Ukraine’s largest drone operations killed at least four people and pushed Russian air defenses into another visible large-scale test around the capital. [Source](https://apnews.com/article/3164d723ca8331e5780ec7942245a2e6)
- **NATO’s common-funding envelope is rising in parallel with the 5% rhetoric:** the alliance says direct common budgets and programmes could reach up to EUR 5.3 billion in 2026, a small share of total defence spending but an important signal about what gets institutionalized collectively. [Source](https://www.nato.int/cps/en/natohq/topics_67655.htm)

### Short Takes

- **Trump’s departure for Beijing was framed by AP as crisis management as much as diplomacy:** the summit began under pressure from the Iran war and energy-security concerns, not just tariff bargaining. [Source](https://apnews.com/article/158574195f3fe49ad48388406916d181)
- **AP’s earlier 800-drone report is still the cleaner way to read the week’s Ukraine file:** the significance was the saturation of about 20 regions at once, not one more isolated attack bulletin. [Source](https://apnews.com/article/caa36f593f0eb2f853921a4580f9810d)
- **The EU’s sanctions language is becoming more operationally precise rather than more theatrical:** the anti-circumvention and crypto provisions are a sign that Brussels is increasingly focused on routing behavior, not just lists of names. [Source](https://finance.ec.europa.eu/news/eu-adopts-20th-package-sanctions-against-russia-2026-04-23_en)
- **NATO’s resilience meetings now treat infrastructure investment as allied security work, not adjunct bureaucracy:** that is a meaningful institutional shift for energy, networks, and defence-industrial planning. [Source](https://www.nato.int/en/news-and-events/articles/news/2026/04/28/senior-national-officials-for-resilience-meet-at-nato-to-address-the-crucial-role-of-resilience-in-allied-security)
...
**Link:** [Read at Springer Nature](https://link.springer.com/article/10.1007/s10676-026-09897-y)
...
- **IAI TV’s pushback against controlled-hallucination metaphysics is a healthy corrective:** not every predictive or generative success should be flattened into one grand theory of mind and reality. [Source](https://iai.tv/articles/reality-is-not-a-controlled-hallucination-auid-3496)
- **Truth-seeking is becoming more important, not less, in the AI age:** Jason Baehr’s case for intellectual virtues still lands because abundant fluent text makes epistemic discipline more, not less, necessary. [Source](https://iai.tv/articles/in-a-post-truth-world-truth-seeking-is-more-important-than-ever-auid-3491)
...
**Link:** [Read at Nature Sustainability](https://www.nature.com/articles/s41893-026-01807-w)
...
- **Phage therapy is becoming more serious where its supporters stop treating it as a miracle and start treating it as a screening, pharmacodynamics, and trial-design problem.** [Source](https://www.nature.com/articles/s41467-026-72590-7)
- **Nature’s antifungal-resistance overview is useful because it keeps the therapeutic story grounded in deployment realities:** new compounds help only if diagnostics and stewardship improve fast enough to preserve them. [Source](https://www.nature.com/articles/d41586-026-01542-4)
...
- **MIT’s summary of “Categorization is baked into the brain” is a useful reminder that abstraction may be a native operating principle rather than a late add-on.** [Source](https://news.mit.edu/2026/rethinking-how-our-brains-use-categories-0507)
- **The review itself is worth reading if you want the stronger claim:** categorization is not a decorative cognitive skill layered on top of perception but part of how the brain builds workable worlds at all. [Source](https://www.nature.com/articles/s41583-026-01036-2)
...
**Link:** [Read at arXiv](https://arxiv.org/abs/2505.04653)
...
**Link:** [Read at WHO](https://www.who.int/emergencies/disease-outbreak-news/item/2026-DON601)

### Short Takes

- **WHO’s earlier update already made the onboard risk distinction clear:** low global risk does not mean low risk for passengers and crew moving through a tightly linked travel environment. [Source](https://www.who.int/emergencies/disease-outbreak-news/item/2026-DON600)
- **Nature’s antifungal-resistance overview is a useful reminder that even when new treatments emerge, the real challenge is aligning diagnostics, stewardship, and clinical deployment before resistance outruns the pipeline.** [Source](https://www.nature.com/articles/d41586-026-01542-4)
...
**Link:** [Read at Nature Chemical Engineering](https://www.nature.com/articles/s44286-026-00392-1)
...
**Link:** [Read at Ars Technica](https://arstechnica.com/space/2026/05/varda-signs-deal-with-major-us-pharma-firm-to-develop-drugs-in-space/)

### Short Takes

- **MIT Technology Review’s phone-number leak story is a governance warning more than a product embarrassment:** conversational interfaces remove the friction that used to keep scraped personal data from being surfaced so directly. [Source](https://www.technologyreview.com/2026/05/13/1137203/ai-chatbots-are-giving-out-peoples-real-phone-numbers/)
...
- **Nature’s embodied-intelligence overview is most persuasive where it treats physical constraint as a feature rather than a limitation:** robots get more useful when prediction, action, and error correction are forced to stay coupled in the real world. [Source](https://www.nature.com/articles/d42473-026-00119-z)
...
**Link:** [Read at Anthropic](https://www.anthropic.com/news/detecting-and-preventing-distillation-attacks)

### Short Takes

- **DeepMind’s AlphaEvolve update is strongest where it shows deployment, not just theorem-chasing:** the system is being used to optimize algorithms inside Google infrastructure, which is the kind of translation frontier AI still needs more of. [Source](https://deepmind.google/blog/alphaevolve-impact/)
- **The new tool-use paper on the “knowing-doing gap” is a good corrective to agent hype:** some models can recognize when tools are needed before they can actually use them well, which is a more revealing failure mode than a simple final score. [Source](https://arxiv.org/abs/2605.14038)
...
**Link:** [Read at IEEE Spectrum](https://spectrum.ieee.org/laser-ground-stations-slash-costs-for-moon-and-mars-data)
...
- **The eta-prime mesic-nucleus signal is one of those particle-physics results that matters because it may let experiment get more directly at where hadron mass comes from in nuclear matter.** [Source](https://physicsworld.com/a/physicists-spot-signs-of-an-atom-like-system-bound-by-the-strong-force-alone/)
- **The physics-mysteries survey story is less about consensus than about fragmentation:** if respondents split sharply on fundamentals, that is a useful reminder that some of the field’s highest-profile questions remain open in a deeper sense than press summaries imply. [Source](https://physics.aps.org/articles/v19/34)
...
**Link:** [Read at EurekAlert!](https://www.eurekalert.org/news-releases/1128081)
...
**Link:** [Explore the new voice models](https://openai.com/index/advancing-voice-intelligence-with-new-models-in-the-api/)
...
**Link:** [Open the GitHub repository](https://github.com/aprilgugroup/Methanotroph-driven-phosphorus-recovery-for-sustainable-wastewater-management)
...
**Link:** [Open the OSF repository](https://osf.io/yagdh)
...
![Aerial view of Thessaloniki city center](https://upload.wikimedia.org/wikipedia/commons/9/93/Thessaloniki_Aerial.png)
