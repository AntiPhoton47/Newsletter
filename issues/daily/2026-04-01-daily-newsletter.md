...
- **S&P 500 (SPY):** 648.34, down 0.74%.
- **NASDAQ-100 (QQQ):** 575.58, down 1.44%.
- **DOW (DIA):** 461.82, up 0.14%.
- **Europe (VGK):** 81.89, up 1.62%.
- **Japan (EWJ):** 83.83, up 0.66%.
- **China (MCHI):** 55.83, up 0.34%.
- **India (INDA):** 46.42, up 0.06%.
- **China large-cap (FXI):** 35.65, up 0.86%.
- **Bitcoin:** 67844.66, up 2.27%.
- **Ethereum:** 2099.04, up 5.41%.
- **Gold (GLD):** 428.28, up 5.98%.
- **Oil proxy (USO):** 127.61, up 11.41%.
- **NVIDIA (NVDA):** 173.63, down 0.90%.
- **Tesla (TSLA):** 371.93, down 2.90%.
- **Palantir (PLTR):** 145.97, down 5.69%.
- **ARM Holdings (ARM):** 149.31, up 10.63%.
...
- **US 10-year Treasury:** 4.44% latest daily close on Mar. 27, 2026. Source: [Treasury via FRED](https://fred.stlouisfed.org/series/DGS10)
- **Brent crude:** $103.79/barrel latest daily print on Mar. 23, 2026. Source: [EIA via FRED](https://fred.stlouisfed.org/series/DCOILBRENTEU)
...
**Link:** [Read at Nature](https://www.nature.com/articles/s41586-026-10131-4)
...
**Link:** [Read at arXiv](https://arxiv.org/html/2603.28627v1)
...
- **Chats with sycophantic AI make you less kind to others:** Nature’s framing is interesting because it treats social style as a systems variable, not a cosmetic choice, which is exactly how serious model deployment should approach interaction design. [Source: Nature](https://www.nature.com/articles/d41586-026-00979-x)
- **Consistent Gauge Conditions for Dust-Shell Dynamics in Effective Quantum Gravity:** Another sign that the strongest foundations work still lies in careful formal housekeeping rather than in grand unification rhetoric. [Source: arXiv](https://arxiv.org/html/2603.24168v1)
...
- **Gut microbiota-mediated lipid accumulation as a driver of evolutionary adaptation to blue light toxicity in Drosophila:** A good example of evolutionary explanation becoming stronger when behavior, metabolism, and microbiota are studied together. [Source: Nature](https://www.nature.com/articles/s41586-026-10114-5)
- **How thoughtful experimental design can empower biologists in the omics era:** Worth reading even outside omics because the underlying lesson is about inferential discipline under conditions of cheap measurement. [Source: Nature](https://www.nature.com/articles/s41467-025-62616-x)
...
**Link:** [Read at Nature](https://www.nature.com/articles/s44220-026-00609-5)
...
- **Mapping the genetic landscape across 14 psychiatric disorders:** The value here is not just scale but the chance to compare overlap and distinction across diagnoses that were often studied too separately. [Source: Nature](https://www.nature.com/articles/s41586-025-09820-3)
- **Topological turning points across the human lifespan:** Another sign that brain science is reaching for richer mathematical descriptors of change rather than relying only on coarse averages. [Source: Nature](https://www.nature.com/articles/s41593-026-01960-5)
...
**Link:** [Read at Nature](https://www.nature.com/articles/s41591-026-04253-5)
...
- **Accelerating AI innovation in healthcare: real-world clinical research applications on the Mayo Clinic Platform:** The practical signal is that deployment quality depends on data governance and institutional tooling, not only model quality. [Source: Nature](https://www.nature.com/articles/s44401-026-00068-1)
- **Reliability of LLMs as medical assistants for the general public:** A useful counterweight to the most casual assumptions about consumer-facing medical chatbots. [Source: Nature](https://www.nature.com/articles/s41746-026-01794-7)
...
- **Human-animal interactions and relations:** A reminder that social theory remains strongest when it studies interdependence rather than strictly human-to-human structures. [Source: Nature](https://www.nature.com/collections/jhfgcbejig)
- **Social clustering of preference for female genital mutilation/cutting in south-central Ethiopia:** Methodologically interesting because it treats attitudes as spatially and socially distributed rather than merely individual. [Source: Nature](https://www.nature.com/articles/s41562-025-02236-z)
...
**Link:** [Read at IEEE](https://ieeexplore.ieee.org/document/11373846/)

### Short Takes

- **Real-time social presence modulation of embodied AI-based robots:** A reminder that social robotics remains partly an audio and interaction-design problem, not only a locomotion problem. [Source: IEEE](https://ieeexplore.ieee.org/iel8/11163731/11163732/11164091.pdf)
- **Embodied Neuromorphic Artificial Intelligence for Robotics:** Worth watching because energy-efficient control and sensing remain core bottlenecks for real deployment. [Source: IEEE](https://ieeexplore.ieee.org/document/11370544)
...
**Link:** [Read at GitHub](https://github.com/microsoft/agent-framework)
...
**Link:** [Read at GitHub](https://github.com/a2aproject/A2A)

### Short Takes

- **Empowering AI data scientists using a multi-agent framework with self-evolving capabilities:** The most useful part of this line of work is whether it makes tool-aware biomedical analysis more reproducible, not whether the systems sound autonomous. [Source: Nature](https://www.nature.com/articles/s41551-026-01634-6)
- **vercel-labs/agent-browser:** Browser automation remains one of the clearest immediate use cases because it translates model intent into ordinary web workflows. [Source: GitHub](https://github.com/vercel-labs/agent-browser)
...
**Link:** [Read at IEEE Spectrum](https://spectrum.ieee.org/satellite-communication-laser-radio-transcelestial)
...
- **Facial recognition is spreading everywhere:** The engineering issue is no longer whether these systems can be built, but whether deployment norms and failure tolerances are anywhere near adequate. [Source: IEEE Spectrum](https://spectrum.ieee.org/facial-recognition-gone-wrong)
- **Sceye is testing out its stratospheric cell tower:** Another example of communications engineering chasing altitude and persistence rather than only more terrestrial density. [Source: IEEE Spectrum](https://spectrum.ieee.org/stratospheric-cell-tower)
...
- **New Series from Quanta Magazine Explores the Infinite Evolution of Math:** Useful as a reminder that mathematical development is cumulative, recursive, and partly historical even when later results look timeless. [Source: Quanta Magazine](https://www.quantamagazine.org/quantanews/new-series-from-quanta-magazine-explores-the-infinite-evolution-of-math/)
- **The Man Who Stole Infinity:** Mathematical biography often illuminates how ideas move socially as well as logically. [Source: Quanta Magazine](https://www.quantamagazine.org/the-man-who-stole-infinity-20260225/)
...
**Link:** [Read at Nature](https://www.nature.com/articles/s41598-025-27438-3)

### Short Takes

- **Ancient rocks reveal early plate motions:** Another reminder that physical archives often preserve dynamical history better than older models assumed. [Source: Science](https://www.science.org/doi/10.1126/science.adz2551)
- **How writing changes mathematical thought:** Historical inquiry becomes strongest when it explains not just what was known but how the conditions of knowing changed. [Source: Quanta Magazine](https://www.quantamagazine.org/how-writing-changes-mathematical-thought-20260325/)
...
**Link:** [Read at Nature](https://www.nature.com/articles/d41586-026-00992-0)
...
- **Faunal exploitation at the elephant hunting site of Lehringen, Germany, 125,000 years ago:** Still a strong example of how faunal remains can refine the interpretation of coordinated behavior. [Source: Nature](https://www.nature.com/articles/s41598-026-42538-4)
- **How DNA in dirt is shaking up the study of human origins:** Sedimentary archives continue to widen what counts as archaeological evidence. [Source: Nature](https://www.nature.com/articles/d41586-024-02447-4)
...
![Madeira coast at Porto Moniz](https://commons.wikimedia.org/wiki/Special:FilePath/Porto%20Moniz%2C%20Madeira%2C%20full%20moon%20over%20beach.jpg)

*Photo: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Porto_Moniz,_Madeira,_full_moon_over_beach.jpg)*
...
**Link:** [Read at Lonely Planet](https://www.lonelyplanet.com/articles/first-time-guide-to-madeira)
