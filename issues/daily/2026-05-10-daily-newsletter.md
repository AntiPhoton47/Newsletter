...
- **S&P 500 (SPY):** 737.62, up 2.35%.
- **NASDAQ-100 (QQQ):** 711.23, up 5.50%.
- **DOW (DIA):** 496.13, up 0.22%.
- **Europe (VGK):** 88.12, up 1.11%.
- **Japan (EWJ):** 92.22, up 4.44%.
- **China (MCHI):** 58.32, up 1.04%.
- **India (INDA):** 49.84, up 1.47%.
- **China large-cap (FXI):** 37.24, up 1.17%.
- **Bitcoin:** 80893.75, down 0.66%.
- **Ethereum:** 2323.44, down 1.16%.
- **Gold (GLD):** 433.77, up 2.50%.
- **Oil proxy (USO):** 133.59, down 6.45%.
- **Micron (MU):** 746.81, up 37.73%.
- **AMD (AMD):** 455.19, up 26.25%.
- **CrowdStrike (CRWD):** 527.77, up 15.83%.
- **ASML (ASML):** 1592.02, up 11.56%.
...
- **US 10-year Treasury:** 4.41% latest daily close on May 07, 2026. Source: [Treasury via FRED](https://fred.stlouisfed.org/series/DGS10)
- **Brent crude:** $118.26/barrel latest daily print on May 01, 2026. Source: [EIA via FRED](https://fred.stlouisfed.org/series/DCOILBRENTEU)
...
**Link:** [Read at Nature](https://www.nature.com/articles/d41586-026-01297-y)
...
**Link:** [Read at Nature](https://www.nature.com/articles/d41586-026-00748-w)
...
**Link:** [Read at Physics World](https://physicsworld.com/a/gap-in-neutrino-energy-spectrum-raises-questions-about-cosmic-environments/)

### Short Takes

- **A memristor that survives above 700 °C is more than a niche materials result:** Physics World reports a graphene-tungsten-hafnium-oxide device that retains data for more than 50 hours, switches in tens of nanoseconds, and could make sensing and computation in extreme environments much less cooling-dependent. [Source](https://physicsworld.com/a/memory-device-breaks-high-temperature-performance-record/)
- **Knot theory has a fresh story because computability is being treated as a first-class design goal:** Quanta’s “QR code” invariant is interesting not only because it is strong, but because it gives theorists a more practical way to distinguish complicated knots without surrendering too much mathematical richness. [Source](https://www.quantamagazine.org/a-powerful-new-qr-code-untangles-maths-knottiest-knots-20260422/)
- **ProgramBench is useful because it asks a harder benchmark question than patching tasks do:** the Facebook Research project measures whether language models can rebuild programs from scratch, which is a cleaner test of abstraction, planning, and software reconstruction than many code-edit leaderboards. [Source](https://github.com/facebookresearch/programbench)
...
**Link:** [Read at AP News](https://apnews.com/article/f8812db41837336d816efaea7bc1c44a)
...
**Link:** [Read at AP News](https://apnews.com/article/7cb7b5cbfbaf993dadfe9bafb5cf5262)
...
**Link:** [Read at AP News](https://apnews.com/article/df01218b89ca925015fe41c700d6beb9)

### Breaking News

- **Qatar has resumed at least some LNG movement through Hormuz:** Bloomberg reports the first Qatari shipment through the strait since the war began, which makes each cargo movement a live test of whether the ceasefire is becoming commercially usable rather than merely diplomatically defensible. [Source](https://www.bloomberg.com/news/articles/2026-05-10/qatar-sends-first-lng-shipment-through-hormuz-since-war-started)

### Short Takes

- **Europe’s Ukraine support is increasingly an industrial-finance story, not just a sanctions story:** the European Commission’s €90 billion Ukraine Support Loan splits support between macro assistance and defence procurement, with drones receiving special derogations because urgency outruns normal sourcing rules. [Source](https://defence-industry-space.ec.europa.eu/eu-defence-industry/ukraine-support-loan_en)
- **The proposed EU-Ukraine Drone Alliance is a concrete sign that procurement is now being organized around throughput:** Brussels is explicitly inviting founding members for a cross-border drone ecosystem rather than treating Ukrainian drone capacity as a temporary battlefield exception. [Source](https://defence-industry-space.ec.europa.eu/funding-opportunities/calls-proposals/call-founding-members-eu-ukraine-drone-alliance_en)
- **China’s marriage slump is still one of the cleaner demographic signals in the world:** Bloomberg reports first-quarter marriage registrations fell to a record low, which matters because marriage remains tightly linked to births, housing demand, and household formation in China’s growth model. [Source](https://www.bloomberg.com/news/articles/2026-05-10/china-s-first-quarter-marriage-registrations-fall-to-lowest-ever)
- **The AP read on Russia’s low-key Victory Day is stronger than the pageantry itself:** the more telling signal was how much security, drone anxiety, and force-preservation shaped the event. [Source](https://apnews.com/article/cde7ec7a0fb10a3e2563171b931485e8)
- **AP’s tariff coverage keeps highlighting the same structural reality:** the next phase of trade conflict is likely to be fought as much through legal interpretation and administrative endurance as through presidential announcements. [Source](https://apnews.com/article/bd6748c3e85533d3ce3644f257f8e326)
...
**Link:** [Read at PhilPapers](https://philpapers.org/rec/DELTEC-12)
...
**Link:** [Read at PhilPapers](https://philpapers.org/rec/TURPTP-4)

### Short Takes

- **Donghee Shin’s “automating epistemology” paper is useful because it treats truth as a sociotechnical output rather than a timeless abstraction:** once AI systems participate in sorting, summarizing, and legitimizing information, verification becomes partly a property of infrastructures. [Source](https://philpapers.org/rec/SHIAEH)
- **The “truth without belief” question is sharper than it sounds:** if LLMs generate sentences that satisfy external truth conditions without anything like belief or commitment, then classical theories may still survive, but our intuitions about speakers and assertions do not. [Source](https://philpapers.org/rec/XUFTWB)
...
**Link:** [Read at Nature Communications](https://www.nature.com/articles/s41467-026-72590-7)
...
**Link:** [Read at Nature Microbiology](https://www.nature.com/articles/s41564-026-02333-3)

### Short Takes

- **The genomic “control knobs” story is getting more practical:** Nature’s latest feature on regulatory DNA is a useful reminder that the hardest part of genomics is no longer reading sequence alone, but identifying which non-coding elements actually govern cellular behavior. [Source](https://www.nature.com/articles/d41586-026-01410-1)
- **Red blood cells and their progenitors are still underestimated as immune actors:** a new *Nature Reviews Immunology* review argues that erythroid lineages do much more immunological work than the traditional oxygen-transport story suggests. [Source](https://www.nature.com/articles/s41577-026-01303-4)
...
**Link:** [Read at Scientific Reports](https://www.nature.com/articles/s41598-026-51403-3)

### Short Takes

- **The commentary on anaesthetized brains is helpful because it narrows the claim:** the surprising result is not hidden consciousness in some sci-fi sense, but preserved sensory integration and linguistic processing in conditions once treated as much more globally silent. [Source](https://www.nature.com/articles/d41586-026-01310-4)
- **Creativity is being treated less as lifestyle ornament and more as brain-maintenance input:** the “brain clocks” study still needs careful interpretation, but it makes a strong case that sustained creative engagement can correlate with measurably younger-looking neural profiles. [Source](https://www.nature.com/articles/s41467-025-64173-9)
...
**Link:** [Read at Nature Communications](https://www.nature.com/articles/s41467-026-72601-7)
...
**Link:** [Read at Nature Health](https://www.nature.com/articles/s44360-026-00116-y)

### Short Takes

- **Medical-assistant LLMs remain more fragile in the wild than in idealized demos:** a randomized preregistered study on public-facing medical assistants is still a useful reminder that interface behavior, not only answer quality, governs safety. [Source](https://www.nature.com/articles/s41591-025-04074-y)
- **WHO’s breast-cancer materials are still worth revisiting because they show what durable public-health communication looks like:** clear incidence framing, explicit risk factors, and direct prevention/treatment guidance remain a good baseline for any AI system claiming to help patients. [Source](https://www.who.int/news-room/fact-sheets/detail/breast-cancer)
...
**Link:** [Read at Bloomberg](https://www.bloomberg.com/news/articles/2026-05-10/china-s-first-quarter-marriage-registrations-fall-to-lowest-ever)
...
**Link:** [Read at Nature Metabolism](https://www.nature.com/articles/s42255-026-01503-1)
...
**Link:** [Read at IEEE Spectrum](https://spectrum.ieee.org/inchfab)
...
**Link:** [Read at IEEE Spectrum](https://spectrum.ieee.org/familiar-machines-and-magic)
...
- **Spectrum’s latest “Video Friday” reel still works as a temperature check for the field:** the most interesting clips increasingly emphasize dexterous manipulation and compliant actuation rather than pure locomotion theater. [Source](https://spectrum.ieee.org/video-friday-robot-hand-artificial-muscles)
- **DAIMON’s 10,000 open hours are a stronger signal than most humanoid launch videos:** data release is what suggests a field wants to compound. [Source](https://spectrum.ieee.org/amp/daimon-robotics-physical-ai-2676818258)
...
**Link:** [Read at IEEE Spectrum](https://spectrum.ieee.org/recursive-self-improvement)
...
**Link:** [Read at WIRED](https://www.wired.com/story/cybercriminals-are-complaining-about-ai-slop-flooding-their-forums/)

### Short Takes

- **Nature’s Agent4Science story remains one of the clearest windows into what scientific agent ecosystems might actually look like:** not abstract “AI for science,” but agents generating, posting, and debating research inside a closed social layer. [Source](https://www.nature.com/articles/d41586-026-01278-1)
- **The Nature work on AI agents replicating human social dynamics is a reminder that coordination problems scale quickly in synthetic populations too:** this matters if agent swarms become normal research or business tooling. [Source](https://www.nature.com/articles/d41586-026-01218-z)
...
**Link:** [Read at Physics World](https://physicsworld.com/a/memory-device-breaks-high-temperature-performance-record/)
...
- **Ancient DNA is continuing to expand the “long history” toolkit faster than many neighboring fields can absorb:** Nature Genetics’ new review on adaptation from ancient DNA is a good reminder that origin stories now increasingly come with direct evolutionary evidence rather than only inference from artifacts. [Source](https://www.nature.com/articles/s41588-026-02562-6)
- **Some of the strongest historical-science work now lives in the interface between climate, mobility, and adaptation rather than in simple chronology:** the new Indigenous-genome result is a strong example because it ties dispersal to durable environmental differentiation. [Source](https://www.nature.com/nature/volumes/653/issues/8113)
...
- **Nature’s “poo and pollutants” archaeology feature remains a good template for the field:** waste streams and molecular residues are often what make past daily life reconstructable at meaningful scale. [Source](https://media.nature.com/original/magazine-assets/d41586-026-00705-7/d41586-026-00705-7.pdf)
- **Ambergris in a late Warring States royal tomb is a reminder that archaeology keeps moving trade and ritual histories earlier when chemistry gets better:** the new molecular evidence pushes a luxury aromatic into the late third century BCE. [Source](https://www.nature.com/articles/s40494-026-02462-2)
...
**Link:** [View on GitHub](https://github.com/earendil-works/pi)
...
**Link:** [View on GitHub](https://github.com/facebookresearch/programbench)
...
**Link:** [View on Product Hunt](https://www.producthunt.com/products/minions)

### Short Takes

- **If you want the cleanest `pi` install path after the repo move, use the new scoped package:** `npm install -g @earendil-works/pi-coding-agent`. [Source](https://pi.dev/news/2026/5/7/pi-has-a-new-home)
- **ProgramBench also has a public site for leaderboard-style browsing, which is useful if you want the benchmark logic without reading the full repo immediately.** [Source](https://programbench.com/)
...
- **For a book pick, `A Parade of Horribles` looks like the cleanest thematic fit:** Matt Dinniman’s next *Dungeon Crawler Carl* volume arrives on **May 12, 2026**, and its “system AI” premise makes it a decent playful companion to a week otherwise dominated by institutional AI stories. [Source](https://www.penguinrandomhouse.com/the-read-down/science-fiction-fantasy-coming-soon/)
...
**Source:** [Lonely Planet](https://www.lonelyplanet.com/destinations/slovenia/julian-alps/bled)

![Lake Bled, Slovenia](https://commons.wikimedia.org/wiki/Special:FilePath/Lake%20Bled%20seen%20from%20Little%20Osojnica%20Hill%20-%20panoramio%20(2).jpg)
